...
10 vulnérabilités ont été retenues dans ce rapport, dont 5 sont prioritaires. Le niveau de risque global est MODÉRÉ.

B - Vulnérabilités Prioritaires

1. **CSP: Failure to Define Directive with No Fallback**
* **Paramètre/Ressource affecté(e) :** `content-security-policy`
* Description : La politique de sécurité du contenu (CSP) ne définit pas une directive qui n'a pas de fallback, ce qui signifie que tout est autorisé.
...
* **Paramètre/Ressource affecté(e) :** `content-security-policy`
* Description : La politique de sécurité du contenu (CSP) autorise l'exécution de scripts inline.
* Référence : https://www.w3.org/TR/CSP/, https://caniuse.com/#search=content+security+policy
* Catégorie OWASP : A05:2021 - Security Misconfiguration
...
* Vérification :
  - Exécuter curl -I https://[site] | grep -i content-security-policy
  - Contrôler que script-src ne contient plus unsafe-inline.
...
* Description : L'attribut de sécurité du sous-contenu (SRI) est absent sur une ressource externe.
* Référence : https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity
* Catégorie OWASP : A08:2021 - Software and Data Integrity Failures
* Recommandation technique : Ajouter l'attribut SRI et le paramètre crossorigin sur les ressources stables et versionnées.
* Vérification :
...
2. Remplacer le joker dans la CSP par une liste précise d’hôtes de confiance.
...
5. Ajouter l'attribut SRI et le paramètre crossorigin sur les ressources stables et versionnées.
