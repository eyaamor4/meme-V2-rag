...
| --- | --- | --- | --- | --- |
| P5 | Cookie No HttpOnly Flag | low | set-cookie: WEBSRVID | 10010 |
| P5 | Cookie without SameSite Attribute | low | set-cookie: WEBSRVID | 10054-1 |
...
| P5 | Technologie détectée : WP-Optimize | info | Version non fournie |  |
| P5 | Technologie détectée : WordPress | info | Version non fournie, 6.4.3 |  |
| P5 | Technologie détectée : Yoast SEO | info | Version non fournie |  |
